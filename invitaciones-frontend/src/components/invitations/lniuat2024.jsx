    ...
    <div>
      ...
      <div className="relative bg-hbg1 min-h-screen flex flex-col justify-between items-center bg-cover bg-center h-auto px-4">
        ...
        <div className="z-10 w-full max-w-sm text-center">
          ...
          <div className="font-bison text-center text-white text-3xl">
            FCAT - UAT
          </div>
        </div>
        ...
        <div className="z-10 w-full max-w-sm text-center">
          ...
          <p className="py-2 font-qanect text-3xl text-white">
        ...
        <div className="z-10 w-full text-center mb-4">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <img
              src={Stars1}
              alt="Stars1"
              className="absolute bottom-[25px] right-[340px] transform w-7"
            />
          </div>
        </div>
      </div>
      ...
      <div className="relative bg-hbg2 min-h-screen flex flex-col justify-between items-center bg-cover bg-center h-auto px-4">
        ...
        <div className="z-10 w-full max-w-sm text-center pt-2">
          ...
          <p className="pt-5 font-playfair text-white text-lg">
        ...
        {/* Segunda subsección */}
        <div className="z-10 w-full max-w-sm text-center">
          <p className="py-1 font-qanect text-3xl">{data.invitado.nombre}</p>
          <p className="pt-2 font-playfair text-lg">
        ...
        <div className="z-10 w-full max-w-sm text-right mt-4">
          {data.graduado.adicional && data.graduado.adicional !== "" ? (
            <p className="font-playfair text-white text-lg py-5">
      ...
      <div className="relative bg-hbg3 min-h-screen flex flex-col justify-between items-center bg-cover bg-bottom bg-no-repeat h-auto px-4">
        <div className="absolute -inset-1 inset- custom-gradient-3"></div>
        ...
        {/* Segunda subsección */}
        <div className="z-10 w-full max-w-sm text-center">
          <p className="py-1 text-white font-qanect text-3xl">
            Hotel HS HOTSSON
          </p>
          {/* <div className="absolute inset-0 flex items-center justify-center">
            <img
              src={Stars2}
              alt="Stars2"
              className="absolute top-[230px] right-[25px] transform w-4"
            />
          </div> */}
          <p className="py-1 text-white font-playfair text-2xl">
            Salon Esmeralda
            <br />
          ...
          <div className="flex justify-center items-center my-32">
            <a
              ...
              className="flex items-center justify-center space-x-2 bg-white/70 text-black py-4 px-6 rounded-full hover:bg-white/90 transition duration-300 font-qanect"
            >
              {/* Icono de ubicación */}
              <img
                src={IconLocation}
